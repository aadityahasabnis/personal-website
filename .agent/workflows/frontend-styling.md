---
description: Implement frontend features with TypeScript and Tailwind CSS, strong SEO and performance standards. When building pages/components, refactoring UI architecture, enforcing class order, applying SSG/ISR, metadata, and render optimization checks.
---
