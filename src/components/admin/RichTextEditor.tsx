...
const AuthorlyEditor = dynamic(() => import('authorly-editor').then((mod) => mod.AuthorlyEditor), { ssr: false, loading: () => <EditorSkeleton /> });
...
export const RichTextEditor = forwardRef<EditorRef, RichTextEditorProps>(function RichTextEditor(
    { value, onChange, onSave, placeholder = "Start writing… press '/' for commands", minHeight = '500px' },
    ref,
) {
