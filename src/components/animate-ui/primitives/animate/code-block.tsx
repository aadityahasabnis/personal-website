...
function CodeBlock({
    ...
    React.useEffect(() => {
        ...
        const el = scrollContainerRef?.current ?? (localRef.current?.parentElement as HTMLElement | null) ?? (localRef.current as unknown as HTMLElement | null);
    ...
    return <div ref={localRef} data-slot='code-block' data-writing={writing} data-done={isDone} dangerouslySetInnerHTML={{ __html: highlightedCode }} {...props} />;
}
