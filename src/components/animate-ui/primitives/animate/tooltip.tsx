...
import { autoUpdate, flip, arrow as floatingArrow, FloatingArrow, offset as floatingOffset, FloatingPortal, shift, useFloating, type UseFloatingReturn } from '@floating-ui/react';
...
function TooltipProvider({ children, id, openDelay = 700, closeDelay = 300, transition = { type: 'spring', stiffness: 300, damping: 35 } }: TooltipProviderProps) {
