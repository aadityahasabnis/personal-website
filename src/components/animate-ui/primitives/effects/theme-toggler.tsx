...
type ChildrenRender = React.ReactNode | ((state: { resolved: Resolved; effective: ThemeSelection; toggleTheme: (theme: ThemeSelection) => void }) => React.ReactNode);
...
export { ThemeToggler, type Direction, type Resolved, type ThemeSelection, type ThemeTogglerProps };
