 ...
 */
const TestimonialCard = ({ quote, author, organization, initials, className }: ITestimonialCardProps) => (
    <div className={cn('group relative', className)}>
        <div className='bg-muted/30 border rounded-lg p-5 hover:shadow-md transition-all duration-300 hover:border-primary/30'>
            ...
            {/* Quote Text */}
            <blockquote className='text-foreground text-sm italic mb-4 pt-4'>&ldquo;{quote}&rdquo;</blockquote>
