...
import { useComments, usePostComment, useUpvoteComment, type ContentType } from '@/hooks/useContentData';
import {
    MessageSquare,
    Send,
    AlertCircle,
                        ...
                        <div className="flex items-center justify-between gap-2 mb-2 flex-wrap">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    aria-label={userHasUpvoted ? 'You upvoted this comment' : 'Upvote this comment'}
                                ...
                                >
                                    <ChevronUp
                                        className={cn('size-3.5 transition-all', userHasUpvoted && 'fill-current')}
                                    />
                                    {upvoteCount}
                                </button>
                            </div>
