 ...
 */
export const StaggerChildren = ({ children, staggerDelay = 0.1, delay = 0, duration = 0.5, once = true, margin = '-50px', className = '' }: IStaggerChildrenProps) => {
    ...
    return (
        <motion.div ref={ref} initial='hidden' animate={isInView ? 'visible' : 'hidden'} variants={customContainerVariants} className={className}>
