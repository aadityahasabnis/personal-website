...
const GradientSphereInner = ({ color1 = '#8b5cf6', color2 = '#ec4899', distort = 0.4, speed = 2 }: IGradientSphereInnerProps) => {
 ...
 */
export const GradientSphere = ({ color1 = '#8b5cf6', color2 = '#ec4899', distort = 0.4, speed = 2, className = '' }: IGradientSphereProps) => {
    return (
        <div className={`absolute inset-0 pointer-events-none ${className}`} aria-hidden='true'>
            <Canvas camera={{ position: [0, 0, 5], fov: 45 }} dpr={[1, 2]} gl={{ antialias: true, alpha: true }}>
                ...
                <GradientSphereInner color1={color1} color2={color2} distort={distort} speed={speed} />
            </Canvas>
        </div>
    );
};
