...
export const StickyScroll = ({ content, contentClassName }: StickyScrollProps) => {
    ...
    const activeContent = content[activeCard] ?? null;
    ...
    return (
        ...
        >
            ...
            <div style={{ background: backgroundGradient }} className={cn('sticky top-10 hidden h-60 w-80 overflow-hidden rounded-md bg-white lg:block', contentClassName)}>
